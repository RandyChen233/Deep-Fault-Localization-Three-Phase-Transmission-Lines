...
Discalimer: the Simulink model is adapted from [this example](https://www.mathworks.com/help/dsp/ug/fault-detection-and-localization-in-three-phase-power-transmission.html) from the Simulink community
